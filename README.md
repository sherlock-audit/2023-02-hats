...
See more in the [Hats Protocol README](https://github.com/Hats-Protocol/hats-protocol/blob/main/README.md) and [Hats Protocol documentation](https://docs.hatsprotocol.org).
...
See more in the [Hats Zodiac README](https://github.com/Hats-Protocol/hats-zodiac/blob/main/README.md).
